...
#ifndef HEADERS_DEQUE_FUNCTIONS_H_
#define HEADERS_DEQUE_FUNCTIONS_H_
...
namespace compare {
template<typename T>
void restack(deque<T>& source, deque<T>& target, int n); //move n elements from source to the back of target
...
#endif /* HEADERS_DEQUE_FUNCTIONS_H_ */
